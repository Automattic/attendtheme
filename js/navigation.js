...
/* global attendScreenReaderText, attendIcons */
( function( $ ) {
	...
	function initMainNavigation( container ) {
		...
		var dropdownToggle = $( '<button />', {
				...
				text: attendScreenReaderText.expand
			})).append( '<span class="meta-nav" aria-hidden="true">'+ attendIcons.dropdown +'</span>' );
		...
		container.find( '.dropdown-toggle' ).click( function( e ) {
			...
			screenReaderSpan.text( screenReaderSpan.text() === attendScreenReaderText.expand ? attendScreenReaderText.collapse : attendScreenReaderText.expand );
	...
	function addTouchSupport() {
		...
		function toggleFocusClassTouchScreen() {
			...
			$( document.body ).on( 'touchstart.attend', function( e ) {
			...
			siteNavigation.find( '.menu-item-has-children > a' ).on( 'touchstart.attend', function( e ) {
		...
		if ( 'ontouchstart' in window ) {
			...
			$( window ).on( 'resize.attend', toggleFocusClassTouchScreen );
			toggleFocusClassTouchScreen();
		}

		siteNavigation.find( 'a' ).on( 'focus.attend blur.attend', function() {
	...
	$( document )
		...
		.ready( function() {
			...
			$( window )
				.on( 'load.attend', onResizeARIA )
				.on( 'resize.attend', onResizeARIA );
		});
